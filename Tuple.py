# Tuple -: Exactly like a list , except you cannot change it once created. It is immutable nature. Use on constant data - days of the 
# week, coordinates or config. values.
   #   0     ,     1    ,  2 ,  3 ,  4 ,  5 ,  6
